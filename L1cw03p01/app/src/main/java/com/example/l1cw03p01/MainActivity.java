...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p1 = findViewById(R.id.ediyText01);
        p2 = findViewById(R.id.ediyText02);
        etykieta = findViewById(R.id.textView01);
    }
